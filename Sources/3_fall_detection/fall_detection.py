...
model.load_state_dict(torch.load(f=r'/home/youngmin/YM/My/savepoint1238.pth'))
...
# cap = cv2.VideoCapture(r'/home/youngmin/YM/SL_disk_b/datasets/Le2i/Coffee_room_01/Coffee_room_01/Videos/video (3).avi')
